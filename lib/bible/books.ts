 ...
 * Mirrors public/bible-data.json — 66 books, OT first (index 0..38), NT second (39..65).
 *
...
export type BibleBook = {
  /** 0-based canonical book index (創=0, …, 瑪=38, 太=39, …, 啓=65) */
  index: number
...
const rawBooks = (bibleData as { books: { a: string; n: string; c: number }[] })
  .books
...
export const NT_TOTAL_CHAPTERS = 260
export const OT_TOTAL_CHAPTERS = 929
export const NT_OT_TOTAL_CHAPTERS = 1189
